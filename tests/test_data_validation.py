...
class TestNaNValueDetection:
    ...
    def test_nan_in_open(
        ...
        result = validator.validate_ohlc(df)
        assert result.is_valid is False
        assert any("open" in err and "NaN" in err or "空值" in err
...
class TestNegativePriceDetection:
    ...
    def test_all_prices_non_positive(
        self,
        validator: DataValidator
    ) -> None:
        """测试所有价格都非正数"""
...
class TestZeroVolumeDetection:
    ...
    def test_continuous_zero_volume_threshold(
        self,
        validator: DataValidator
    ) -> None:
        """测试连续零成交量超过阈值"""
...
class TestEmptyDataHandling:
    ...
    def test_price_continuity_empty_df(
        self,
        validator: DataValidator
    ) -> None:
        """测试空DataFrame的连续性检查"""
...
class TestMultipleIssuesAccumulation:
    ...
    def test_errors_and_warnings_combined(
        self,
        validator: DataValidator
    ) -> None:
        """测试错误和警告混合"""
...
class TestBoundaryConditions:
    ...
    def test_exactly_at_limit_threshold(
        self,
        validator: DataValidator
    ) -> None:
        """测试恰好在限制边界"""
    ...
    def test_just_above_limit_threshold(
        self,
        validator: DataValidator
    ) -> None:
        """测试略高于限制边界"""
    ...
    def test_very_small_positive_volume(
        self,
        validator: DataValidator
    ) -> None:
        """测试极小的正成交量"""
...
class TestLargeDatasets:
    ...
    def test_large_dataset_with_errors(
        self,
        validator: DataValidator
    ) -> None:
        """测试大型数据集包含错误"""
...
class TestSpecialCases:
    ...
    def test_very_high_volume_spike(
        self,
        validator: DataValidator
    ) -> None:
        """测试极端的成交量尖峰"""
