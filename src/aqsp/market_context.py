...
_CROSS_MARKET_RULES: tuple[CrossMarketImplicationRule, ...] = (
    ...
    CrossMarketImplicationRule(
        rule_id="us_rate_dollar_risk_off",
        keywords=(
            "美债收益率上行",
            "美债利率上行",
            "美债收益率走高",
        ...
        required_keyword_groups=(
            ("美债", "美债收益率", "美元", "美元指数", "dxy", "10年美债", "十年美债"),
            ("上行", "走强", "走高", "飙升", "攀升", "利率上行", "收益率上行"),
        ),
        theme="海外利率美元上行压制",
        linkage_basis="利率汇率压制估值与外资",
        supportive_impacts=("negative",),
        a_share_targets=("高估值成长", "外资重仓", "港股核心资产"),
        first_order_targets=("高估值成长", "外资重仓消费医药", "港股核心资产"),
        second_order_targets=("半导体估值", "创新药", "新能源高杠杆标的"),
        pressure_targets=("高估值成长", "外资重仓", "港股核心资产"),
        execution_watchpoints=(
            "次日成长方向是否延续弱势、防御是否占优",
            "北向/外资流向与人民币汇率",
            "美债10Y与美元指数是否继续上行",
        ...
        confirmation_hint="优先看利率汇率方向、外资流向与高估值成长承接。",
    ),
    CrossMarketImplicationRule(
