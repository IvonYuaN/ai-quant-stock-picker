    ...
    report = CatalystReport(
        ...
        events=(
            CatalystEvent(
                ...
                supporting_evidence=("财联社披露报价变化",),
                transmission_path=("覆铜板涨价", "PCB厂商毛利预期"),
                validation_signals=("板块放量扩散",),
                invalidation_signals=("报价回落",),
            ),
        ),
    )
    ...
    report = CatalystReport(
        ...
        events=(
            CatalystEvent(
                ...
                transmission_path=("覆铜板涨价", "PCB厂商毛利预期"),
                supporting_evidence=("交易所公告披露供应商库存",),
    ...
    report = CatalystReport(
        ...
        events=(
            CatalystEvent(
                ...
                source_quality_score=3,
                affected_sectors=("PCB",),
                supporting_evidence=("公司公告披露订单变化",),
                transmission_path=("订单事实", "产业链需求"),
                validation_signals=("订单继续确认",),
                invalidation_signals=("订单取消",),
            ),
        ),
        warnings=("消息缓存回退: 使用 5 分钟前摘要",),
    )
    ...
    report = CatalystReport(
        ...
        events=(
            CatalystEvent(
                ...
                source_quality_score=3,
                affected_sectors=("PCB",),
                supporting_evidence=("路透报道需求变化",),
                transmission_path=("需求事实", "产业链需求"),
                validation_signals=("需求回暖",),
                invalidation_signals=("需求继续下滑",),
            ),
            CatalystEvent(
                title="下游需求放缓",
                source="路透",
                ...
                source_quality_score=3,
                affected_sectors=("PCB",),
                supporting_evidence=("路透报道需求放缓",),
                transmission_path=("需求事实", "产业链需求"),
                validation_signals=("需求继续下滑",),
                invalidation_signals=("需求重新回暖",),
            ),
        ),
    )
    artifact = build_market_context_artifact(
