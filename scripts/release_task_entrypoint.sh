...
export AQSP_LOG_ROOT="${AQSP_LOG_ROOT:-${RUNTIME_DATA_ROOT}/logs}"
...
# The formal public surface is React + FastAPI. Keep any offline archive under
# runtime data and outside the public application entry.
