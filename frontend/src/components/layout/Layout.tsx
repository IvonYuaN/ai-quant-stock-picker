...
import {
  Activity, Radar, Settings, FileSearch,
...
const NAV = [
  ...
  { to: "/intel", icon: Radar, label: "资讯核验" },
  { to: "/paper-research", icon: FileSearch, label: "纸面研究" },
];
    ...
    <div className="flex h-screen">
      ...
      <aside className={cn(
        ...
        <div className={cn("border-b border-border/50", collapsed ? "flex justify-center p-3" : "p-4")}>
          ...
          {!collapsed && <p className="mt-1 text-[11px] text-muted-foreground">AQSP 研究工作台 · A股 / 美股 / 港股</p>}
        </div>
        ...
        <div className={cn("border-t border-border/50", collapsed ? "flex flex-col items-center gap-2 p-2" : "space-y-2 p-3")}>
          {collapsed ? (
            <>
              ...
              <Link to="/settings" className="rounded p-1.5 text-muted-foreground transition-colors hover:text-foreground" title="连接设置">
            ...
            <>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Link to="/settings" className="text-[11px] text-muted-foreground/70 transition-colors hover:text-foreground" title="连接设置">连接设置</Link>
